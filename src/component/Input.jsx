    ...
    return (
        <main className='flex justify-between px-[50px] py-[40px]'>
            ...
            <div className='bg-[#2b3945] w-[25%] h-[43px] rounded-[5px] border-none algin-center items-center'>
                <input type="text" name="" id="" placeholder='Search for a country...' onChange={(e)=>setSearchTerm(e.target.value)} className='outline-none px-[15px] text-white w-[100%] h-[43px] ' />
            </div>
